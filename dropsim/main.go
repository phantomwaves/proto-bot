...
func (d *DataWrapper) ParseDrops() DropTable {
	...
	//for _, v := range output.Drops {
	//fmt.Printf("Name: %s, Rarity: %s, Rarity(decimal): %.5f Quantity: %v to %v\n", v.Name, v.Rarity, v.RawRarity, v.QuantityLow, v.QuantityHigh)
	//}
	return output
}
